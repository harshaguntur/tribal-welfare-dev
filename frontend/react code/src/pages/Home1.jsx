    ...
    <div className="Home1-outer-div">
      ...
      <div className="right">
        ...
        <div className="img-container">
          ...
          <div className="rect1">
            <img src="../../public/tribal photos/WhatsApp Image 2023-11-20 at 12.03.15.jpeg" height="200" width="350" />
          </div>
          ...
          <div className="rect2">
            <img
              className="img2"
              src="../../public/tribal photos/WhatsApp Image 2023-11-20 at 12.02.59.jpeg"
              height="200"
              width="255"
            />
          </div>
          ...
          <div className="rect3">      
            <img src="../../public/tribal photos/WhatsApp Image 2023-11-20 at 12.02.59 (2).jpeg" height="200" width="405" />{" "}
          </div>
          ...
          <div className="circle">         
            <img
              className="imgcir"
              src="../../public/tribal photos/WhatsApp Image 2023-11-20 at 12.11.41.jpeg"
              height="200"
              width="200"
            />
          </div>
          ...
          <div className="rect4">      
            <img
              className="img4"
              src="../../public/tribal photos/WhatsApp Image 2023-11-20 at 12.02.59 (1).jpeg"
              height="180"
              width="258"
            />
          </div>
    ...
    <div className="bottom">
      ...
      <div className="textbox">
        <div id="text-div">
         ...
         <p>The Environment is not seperate from us.</p>
